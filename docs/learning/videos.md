...
|---------|-------|----------|
| 01 | Setting up your workspace | 5 min |
...
| Episode | Topic | Duration |
|---------|-------|----------|
| 04 | Using the API with JavaScript | 12 min |
| 05 | Team collaboration workflows | 10 min |
| 06 | Custom layouts and templates | 9 min |

::: tip
All videos are available in HD. You can slow down or speed up playback using your video player controls.
:::
